...
class SettingsController:
    def __init__(self, parent, main_app_callback):
        """
        :param parent: The parent widget where the SettingsView is placed.
        :param main_app_callback: A function in the MainApp that can be called when the user clicks 'Start Game'.
        """
    ...
    def start_game_clicked(self):
        ...
        Sync data from view to model, then notify the main app.
        """
        ...
        self.model.ai_max_depth = self.view.get_ai_max_depth()
        self.model.ai_time_limit_ms = self.view.get_ai_time_limit_ms()
